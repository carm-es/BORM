...
public class ParseadorXMLPades extends ParseadorXML {
	...
	public ParseadorXMLPades(String xml)
	...
	public boolean pendienteDeActualizacion() {
		...
		if (resultado.equals(ParseadorXMLPades.PENDIENTE)) {
			return true;
		}
		return false;
	}
	...
	public boolean hayError() {
		String resultado = getCodigoResultado();
		if (resultado.equals(ParseadorXMLPades.ERROR_TIPO_1) || resultado.equals(ParseadorXMLPades.ERROR_TIPO_2)) {
			return true;
		}
		return false;
	}
	...
	public boolean hayExito() {
		String resultado = getCodigoResultado();
		if (resultado.equals(ParseadorXMLPades.EXITO)) {
			return true;
		}
		return false;
	}
